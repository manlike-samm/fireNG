export const largeCardSections = [
  {
    id: 1,
    title: "Top-rated Fire Extinguisher in Nigeria",
    snippet:
      "User say these are the best fire extinguishers to rent if your house is burning down.",
    cards: [
      {
        id: 19,
        title: "Lagos's Portable 2L Fire Extinguisher",
        snippet:
...
export const smallCardSections = [
  {
    id: 1,
    title: "Fire Extinguisher in Lagos",
    cards: [
      {
        id: 1,
        image: "fe7.jpg",
  ...
  {
    id: 2,
    title: "Fire Extinguisher in Nigeria",
    cards: [
      {
        id: 13,
        image: "fe19.jpg",
